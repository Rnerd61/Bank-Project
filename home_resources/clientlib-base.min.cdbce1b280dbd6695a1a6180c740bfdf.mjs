      ...
      function addIcon(link) {
        ...
        let findType = false;
          ...
          if(!findType && !link.querySelector('picture')) {
            ...
            link.insertAdjacentHTML('beforeend', '<span class="new-window-icon"><svg width="12px" height="13px" viewBox="0 0 12 13" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">'
            +'<title></title>'
...
(function ($, $document) {
    ...
    $(document).ready(function () {
        ...
        if(!(promoBreakerVideoId == null || promoBreakerVideoId == '' || promoBreakerVideoId == undefined)) {
            appendPromoBreakerVideoSchema(promoBreakerVideoId);
        }
    });
})(jQuery, jQuery(document));


function appendPromoBreakerVideoSchema(videoId) {
    var videoData;
    var url = window.location.href;
    var arr = url.split("/");
    var contextPath = '/'+arr[3];
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                                ...
                                + "\",\n\"transcript\": \"" + $('.cmp-promobreaker_transcript_'+videoId).text()+"\"";

            $(".cmp-promobreaker-video_"+videoId).text("{ \n"  + videoSchema + " \n }");
...
$(document).ready(function() {
  ...
  $('.subscribe-content input').on('checkval', function () {
...
$(document).ready(function() {
    ...
    function appendVideoObject(videoData,videoId) {
		...
		var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                        ...
                        + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                        + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                        + "\",\n\"transcript\": \"" + $('.cmp-videocard_transcript_'+videoId).text()+"\"";

		$(".video-card_"+videoId).text("{ \n"  + videoSchema + " \n }");
		if (videoObj.length) {
...
(function ($, $document) {
    ...
    $(document).ready(function () {
        ...
        if(!(practiceHeroVideoId == null || practiceHeroVideoId == '' || practiceHeroVideoId == undefined)) {
            appendPracticeHeroVideoSchema(practiceHeroVideoId);
        }
...
function appendPracticeHeroVideoSchema(videoId) {
    var videoData;
    var url = window.location.href;
    var arr = url.split("/");
    var contextPath = '/'+arr[3];
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                                ...
                                + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                                + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                                + "\",\n\"transcript\": \"" + $('.practicehero-transcript_'+videoId).text()+"\"";

            $(".practice-hero-video_"+videoId).text("{ \n"  + videoSchema + " \n }");
...
function fetchVideoMetadataDuration(video) {
  ...
  $.ajax({
    ...
    success: function (result) {
      videoData = result;
        appendVideoPlayListVideoSchema(videoData, videoId);
    },
  });
}

function appendVideoPlayListVideoSchema(videoData,videoId) {
	var videoObj = JSON.parse(JSON.stringify(videoData));
	var videoTime =videoObj.length;
		var minutes = Math.floor(videoTime / 60000);
		var seconds = ((videoTime % 60000) / 1000).toFixed(0);
    ...
    var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                        ...
                        + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                        + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                        + "\",\n\"transcript\": \"" + $('.cmp-videoplay_transcript_'+videoId).text()+"\"";

    $(".video-play-list-video_"+videoId).text("{ \n"  + videoSchema + " \n }");
    appendVideoObjectDuration(videoObj);
}


/** Function to append the VideoJS Object to corresponding VideoCard on the Page **/
function appendVideoObjectDuration(obj) {
...
setTimeout(function(){
    ...
    $(".cmp-videoplay__container .vjs-control-bar .vjs-play-control").attr("data-analytics-button",videoPlayListTitle+" | Video Playlist | "+ activeVideoName.trim());
    $(".cmp-videoplay__container .cmp-videoplay__image .video-js .vjs-big-play-button").attr("data-analytics-button",videoPlayListTitle+" | Video Playlist | "+ activeVideoName.trim() +" | Play");
...
$(".cmp-videoplay__carousel--link").click(function() {
  ...
  $(".cmp-videoplay__container .vjs-control-bar .vjs-play-control").attr("data-analytics-button",videoPlayListTitle+" | Video Playlist | "+ videoName.trim());
...
$(document).ready(function () {
	...
	function fetchinlineVideoDuration(video) {
		...
		$.ajax({
			...
			success: function (result) {
				videoData = result;
				appendInlineVideoSchema(videoData, videoId);
			},
		});
	}

	function appendInlineVideoSchema (videoData,videoId) {
	var videoObj = JSON.parse(JSON.stringify(videoData));
	var videoTime =videoObj.length;
             var minutes = Math.floor(videoTime / 60000);
             var seconds = ((videoTime % 60000) / 1000).toFixed(0);
			 ...
			 var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                        ...
                        + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                        + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                        + "\",\n\"transcript\": \"" + $('.inlinevideo-transcript_'+videoId).text()+"\"";

    $(".cmp-inline-video_"+videoId).text("{ \n"  + videoSchema + " \n }");
    appendInlineVideoDuration(videoObj);
}
...
(function ($, $document) {
    ...
    $(document).ready(function () {
        ...
        if(!(subCatHeroVideoId == null || subCatHeroVideoId == '' || subCatHeroVideoId == undefined)) {
            appendSubCategoryHeroVideoSchema(subCatHeroVideoId);
        }
...
function appendSubCategoryHeroVideoSchema(videoId) {
    var videoData;
    var url = window.location.href;
    var arr = url.split("/");
    var contextPath = '/'+arr[3];
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                                ...
                                + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                                + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                                + "\",\n\"transcript\": \"" + $('.subcategoryhero_transcript_'+videoId).text()+"\"";

            $(".subcategory-hero-video_"+videoId).text("{ \n"  + videoSchema + " \n }");
...
function fetchVideoMeta(video) {
    ...
    $.ajax({
        ...
        success: function (result) {
            videoData = result;
            appendFourUpVideoSchema(videoData,video);
        },
    });
}

function appendFourUpVideoSchema (videoData,video) {
	var videoObj = JSON.parse(JSON.stringify(videoData));
    var videoId = video.attr('data-videoid');
    var videoTime =videoObj.length;
    var minutes = Math.floor(videoTime / 60000);
    ...
    var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                        ...
                        + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                        + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                        + "\",\n\"transcript\": \"" + $('.four-up_video_transcript_'+videoId).text()+"\"";

    $(".four-up__video_"+videoId).text("{ \n"  + videoSchema + " \n }");
    getVideoDuration(videoObj, video);
}


function getVideoDuration(videoObj, video) {
...
(function ($, $document) {
    ...
    $(document).ready(function () {
        ...
        if(!(detailsHeroVideoId == null || detailsHeroVideoId == '' || detailsHeroVideoId == undefined)) {
            appendBizDetailsHeroVideoSchema(detailsHeroVideoId);
        }
...
function appendBizDetailsHeroVideoSchema(videoId) {
    var videoData;
    var url = window.location.href;
    var arr = url.split("/");
    var contextPath = '/'+arr[3];
        ...
        success: function (result) {
            ...
            var videoTime =videoObj.length;
             ...
             var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                                ...
                                + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                                + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                                + "\",\n\"transcript\": \"" + $('.detailshero_transcript_'+videoId).text()+"\"";

            $(".details-hero-video_"+videoId).text("{ \n"  + videoSchema + " \n }");
...
function fetchOneUpVideoMeta(video) {
    ...
    $.ajax({
        ...
        success: function (result) {
            videoData = result;
            appendOneUpVideoSchema(videoData,video);
        },
    });
}

function appendOneUpVideoSchema (videoData,video) {
	var videoObj = JSON.parse(JSON.stringify(videoData));
    var videoId = video.attr('data-videoid');
    var videoTime =videoObj.length;
    var minutes = Math.floor(videoTime / 60000);
    ...
    var videoSchema = "\"@context\": \"https://schema.org\",\n\"@type\": \"VideoObject\",\n\"name\": \"" + videoObj.name
                        ...
                        + "\",\n\"publisher\": \n \t{\n\t\"@type\": \"Organization\",\n\t\"name\": \"Morgan Stanley\",\n\t\"logo\": \n\t\t{ \n\t\t\"@type\": \"ImageObject\",\n\t\t\"url\": \"https://www.morganstanley.com/etc/designs/msdotcom/image/mstile-310x310.png\",\n\t\t\"width\": 310,\n\t\t\"height\": 310 \n \t\t}\n\t}"
                        + ",\n\"embedUrl\": \"http://players.brightcove.net/644391012001/5xC7AvkxM_default/index.html?videoId="+videoId
                        + "\",\n\"transcript\": \"" + $('.one-up__video_transcript_'+videoId).text()+"\"";

    $(".one-up__video_"+videoId).text("{ \n"  + videoSchema + " \n }");
    getOneUpVideoDuration(videoObj,video);
}
...
$(document).ready(function() {
    ...
    var investmentNeeds = [];
    var languages = [];
    var fadataJSON = aem_context+"/content/dam/msdotcom/appdata/fa-matchbook.json?v="+Math.round(Math.random() * 1000);
    var loadingImg = "<div class='fa-notfound'><img src='"+aem_context+"/content/dam/msdotcom/img/fa-matchbook/indicator.gif' alt='Loading' width='16' height='16'></div>";
...
(function ($, $document) {
    ...
    $(document).ready(function () {
        ...
        $.each(opportunityEndlessGrid, function(index, endlessGrid) {
            ...
            if(endlessGridData.resultSet) createDynamicCards(endlessGridData.resultSet, endlessGrid, limit, opportunityType);
        });
    });
      ...
      //  console.log(getBusinessArea);
        ...
        $(".experienceHire .cmp-opportunity--filter__slick").on('beforeChange', function(event, slick, currentSlide, nextSlide) {
            if(nextSlide == 0)
            {
              // $(".experienceHire .cmp-opportunity--filter__slick").slick('unslick');
                ...
                $(".backButton").attr("data-analytics-button", "Career Search Flow | Experienced Professionals | Quick Search | Back" );
                $(".helpUs, .what--looking--title").hide();
            }
        });
       ...
       switch (getJobQuery.toLowerCase()) { 
        ...
        $('.backButton').click(function(e){ 
            e.preventDefault();
            if($('.cmp-opportunity--quicksearch:visible').length == 1){
...
var OPPORTUNITY_AGGREGATE_CLASS = "cmp-opportunity-aggregate",
OPPORTUNITY_AGGREGATE_BTN_SELECTOR= ".cmp-opportunity-aggregate .button--done",
...
$(document).ready(function() {
    ...
    if(url.indexOf('students-graduates/opportunities') > -1) {
        ...
        if (splitURL[splitURL.length - 1] !== 'not-found') {
           // var jobDataArray = getTitleAndDescription();
          var jobDataArray = getBusinessAreaVariation();
            jobDataArray[1];

            if (jobDataArray[1]) {
                if (splitURL[3] === 'auth' || splitURL[3] === 'pub') {
                    var pageNotFound = origin + contextPath + '/content/msdotcom/en/career/students-graduates/opportunities/not-found';
                    window.location.replace(pageNotFound);
                }
                else {
                    var pageNotFound = origin + '/career/students-graduates/opportunities/not-found';
                    window.location.replace(pageNotFound);
                }
            } else {
...
if(getURLString > -1 ) {
    careerURL = careerAPI;
    // careerURL = "http://ivapp1186233.devin3.ms.com:2805/web/career_services/webapp/service/careerservice/resultset.json?&opportunity=sg&lang=EN";
...
/*else {
    //careerURL = window.location.origin+"/web/career_services/webapp/service/careerservice/resultset.json?&opportunity=ep&lang=EN";
    careerURL = "http://ivapp1186233.devin3.ms.com:2805/web/career_services/webapp/service/careerservice/resultset.json?&opportunity=ep&lang=EN";
    heroCareerEyeBrow = "EXPERIENCED PROFESSIONALS";
    postLabel = "Posted Date";
}*/
...
$.ajax({
   ...
   success: function(data) {
    ...
    let storyCardClass = $(".storycard.aem-GridColumn.aem-GridColumn--default--12");
    $.each(storyCardClass, function(i, key) {
       $(this).addClass("aem-GridColumn--default--3");
    }); 
...
/* Set analytics attr for endless grid ends */
...
function getLocations(region, city, country,  jobId){
  ...
  //let locationURL = locationAPI + regionName+"|"+countryName;
  ...
      },
      ...
      error: function(data) {
        console.log("location erro==",data);
      }
});
}
...
function renderLocation(data, cityName, region, country, jobId, countryDisplayNames) {
  ...
  for (let key in data) {
        ...
        count++;
          ...
          +'</div>'
          +'<div class="cmp-storycard__content">'
          +'<div class="cmp-storycard__eyebrow">LOCATION</div>'
          +'<span class="cmp-storycard__title">'
...
function renderMeetTheTeam(data) {
  ...
  for(let key in data) {
      ...
      personName = data[key].firstName + (data[key].lastName ? (' ' +data[key].lastName) : '');
          ...
          +'</picture>'
          +'</div>'
          +'<div class="cmp-personcard__content">'
          +'<div class="cmp-personcard__eyebrow">Our People</div>'   
          +'<span class="cmp-personcard__title">'+data[key].firstName+' '+data[key].lastName+'</span>'
...
$(document).ready(function () {
   ...
   // console.log("getEventsBusinessArea>>"+getEventsBusinessArea)
    ...
    let eventCollectedLoacations = getQueryParamaters(queryParamaters,'events');
    //createRequestEventsResultSet(collectedParameterValues+'&location='+eventCollectedLoacations);
...
function getEventsResultsDiv(data) {
	...
	if(window.innerWidth < 767) {
        ...
        locations ='';
       // location_descripton = getQueryParamaters({region:[],country:multiCity,state:[],city: []});
        let childDiv = "<div class='jobcard'>"+
                "<div class='cmp-jobcard'>"+
                    '<div class="cmp-jobcard__link" >'+
                        '<div class="cmp-jobcard__content">'+
                            ...
                            '<div class="jobId" style="display: none"><span> '+data.businessUnit + '</span>' +
                           ...
                           '<div class="description_section " style="display: none" >' +
                            // '<div>'+ appPostDate +': ' + data.eventStartDate +'</div>' +
                            // '<div>'+ typeOfEvent +': ' + data.eventType + '</div>' +
                            '<h4>Locations</h4>' +
...
$(document).ready(function() {
    ...
    if(url.indexOf('students-graduates/events') > -1) {
        ...
        if (splitURL[splitURL.length - 1] !== 'not-found') {
           // var jobDataArray = getEventTitleAndDescription();
           var jobDataArray = getevenTypeVariation();
            jobDataArray[1];

            if (jobDataArray[1]) {
                if (splitURL[3] === 'content') {
                    var pageNotFound = origin + contextPath + '/content/msdotcom/en/career/events-aggregate/not-found';
                    window.location.replace(pageNotFound);
                }
                else {
                    var pageNotFound = origin + '/career/events-aggregate/not-found';
                    window.location.replace(pageNotFound);
                }
            } else {
...
function getevenTypeVariation() {
    ...
    if(getURLString > -1 ) {
        // careerURL = "http://ivapp1186233.devin3.ms.com:2805/web/career_services/webapp/service/careerservice/eventdetails.json?category=sg";
...
    },
    ...
    //  console.log("eventData===",data);
      ...
      console.log("events html===",html_to_append)
       // $(".details-description").html(html_to_append);
...
function getUpComingEvents(eventsURL) {
    var result = [];
        $.ajax({
            ...
            success: function (data) {
            //    result = data.eventResults!== null ? data.eventResults : [] ;
                result = data;
                return result;
            },
            error: function (data) {
...
(function ($, $document) {
    ...
    $(document).ready(function () {
        ...
        if (splitURL[3] === 'content') {
            ...
            endlessEvents = origin + '/web/career_services/webapp/service/careerservice/eventendlessgrid.json';
        }
        ...
        function endlessEventsGrid(data) {
            if (data != null && data.row.length >= 4) {
                ...
                for (let count = 0; count < 4; count++) {
                    if (arr[3] === 'content') {
                        careerUrl = origin + contextPath + '/msdotcom/en/careers/students-graduates/events.' + data.row[count].id + '.html?wcmmode=disabled';
                    } else {
                        careerUrl = origin + '/careers/students-graduates/events/' + data.row[count].id;
                    }
